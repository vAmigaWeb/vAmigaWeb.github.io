...
const core_version  = '4.1.2'; //has to be the same as the version in Emulator/config.h and vAmiga_browser.js
const ui_version = '2025_05_27b'+url_root_path.replace("/","_"); 
