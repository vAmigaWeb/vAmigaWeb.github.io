...
//            console.log('The pointer lock status is now unlocked');  
    ...
    function emulate_mouse_touchpad_start(e)
    {
        for (var i=0; i < e.changedTouches.length; i++) {
            ...
            let mouse_touchpad_move_area= touch.clientX > window.innerWidth/8 &&
            touch.clientX < window.innerWidth-window.innerWidth/8;
            
            let mouse_touchpad_button_area=!mouse_touchpad_move_area;

            if(mouse_touchpad_button_area)
            {
                let left_button = touch.clientX < window.innerWidth/8;        
                if(left_button)
                {
